        ...
        <div className="col-lg-8">
          ...
          <tbody>
            ...
            <tr key={index}>
              <td>{index+1}</td>
              <td>{product.title}</td>
              <td> <img style={{width:"300px", height:"200px"}} src={product.thumbnail} alt="" /> </td>
              <td><input type="text" value={product.quantity} readOnly style={{width:"25px"}} className='form-control'/></td>
